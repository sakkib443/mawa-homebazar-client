                    ...
                    <div key={zone._id} className="bg-white rounded-md border border-gray-200 p-5 shadow-sm hover:shadow-md transition-all relative group">
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <div className="flex gap-2 transition-opacity">
                                <button onClick={() => onEdit(zone)} className="p-1.5 text-gray-400 hover:text-blue-500"><LuSquarePen size={16} /></button>
                                <button onClick={() => onDelete(zone._id)} className="p-1.5 text-gray-400 hover:text-red-500"><LuTrash2 size={16} /></button>
                            </div>
                        </div>
                                ...
                                <tr key={rate._id} className="hover:bg-gray-50/50">
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <div className="flex justify-end gap-2">
                                            <button onClick={() => onEdit(rate)} className="p-2 text-gray-400 hover:text-blue-500 bg-gray-50 rounded-md"><LuSquarePen size={16} /></button>
                                            <button onClick={() => onDelete(rate._id)} className="p-2 text-gray-400 hover:text-red-500 bg-gray-50 rounded-md"><LuTrash2 size={16} /></button>
                                        </div>
                                    </td>
                                </tr>
                            ))
    ...
    return (
        <div className="bg-white rounded-md border border-gray-200 shadow-sm p-6 max-w-3xl space-y-7">
            ...
            <section className="space-y-4">
                <h3 className="text-sm font-bold text-gray-800 flex items-center gap-2"><LuTrendingUp size={16} /> Free shipping by order value</h3>
            ...
            <section className="space-y-4 border-t border-gray-100 pt-6">
                <h3 className="text-sm font-bold text-gray-800 flex items-center gap-2"><LuPackage size={16} /> Free shipping by quantity</h3>
            ...
            <section className="space-y-4 border-t border-gray-100 pt-6">
                <h3 className="text-sm font-bold text-gray-800 flex items-center gap-2"><LuMapPin size={16} /> Default delivery rates</h3>
            ...
            {/* Platform commission */}
            <section className="space-y-4 border-t border-gray-100 pt-6">
                <h3 className="text-sm font-bold text-gray-800 flex items-center gap-2"><LuTrendingUp size={16} /> Platform commission</h3>
                <p className="text-[11px] text-gray-400 -mt-2">
                    Commission is charged per <b>category</b> (set it on each category in Categories).
                    The rate below is the fallback used only when a product&apos;s category has no commission set. It is the same for every seller.
                </p>
                {numField('Default commission rate', 'defaultCommissionRate', '%', 'e.g. 10 — applied when the product category (and its parents) have no rate.')}
            </section>
...
export default function ShippingPage() {
    ...
    const tabs = [
        { id: 'shipments', label: 'Shipments', icon: LuTruck },
        { id: 'zones', label: 'Zones', icon: LuMapPin },
        { id: 'rates', label: 'Rates', icon: LuTrendingUp },
        { id: 'settings', label: 'Settings', icon: LuSettings },
    ];

    const statCards = [
        { label: 'Pending', value: stats.pending, icon: LuClock, color: 'text-amber-600', bg: 'bg-amber-50', border: 'border-amber-100' },
        { label: 'In Transit', value: stats.inTransit, icon: LuTruck, color: 'text-blue-600', bg: 'bg-blue-50', border: 'border-blue-100' },
        { label: 'Delivered', value: stats.delivered, icon: LuCircleCheck, color: 'text-emerald-600', bg: 'bg-emerald-50', border: 'border-emerald-100' },
        { label: 'Avg. Days', value: stats.avgDeliveryDays || '0', icon: LuClock, color: 'text-purple-600', bg: 'bg-purple-50', border: 'border-purple-100' },
    ];
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex gap-3">
                    ...
                    >
                        <LuRefreshCw size={16} className={isShipmentsLoading ? 'animate-spin' : ''} />
                        Refresh
                    </button>
