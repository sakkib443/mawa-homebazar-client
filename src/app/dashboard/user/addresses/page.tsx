...
export default function AddressesPage() {
    ...
    /**
     * The picker owns division/district/upazila; `city` and `area` are kept in
     * sync from it because shipping rates still match on the city string and
     * older addresses only have that.
     */
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
                        ...
                        <form onSubmit={handleSubmit} className="p-5 space-y-4">
                            ...
                            <AreaSelect
                                ...
                                required
                                value={{ division: form.division, district: form.district, upazila: form.upazila }}
                                onChange={handleArea}
                            />

                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-xs font-bold text-gray-500 mb-2">City / Town</label>
                                    <input type="text" required value={form.city} onChange={(e) => setForm({ ...form, city: e.target.value })}
                                        className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-[var(--color-primary)] outline-none text-sm transition-all" placeholder="Filled from your district" />
                                </div>
                                <div>
