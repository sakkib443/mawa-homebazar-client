...
import { LuCircleCheck, LuPackage, LuArrowRight, LuShoppingBag } from 'react-icons/lu';
        ...
        <div className="bg-gray-50/50 min-h-screen flex items-center justify-center py-20 px-4">
            <div className="max-w-md w-full bg-white rounded-md border border-gray-100 shadow-2xl shadow-gray-200/50 p-10 text-center animate-fadeIn">
                ...
                <div className="space-y-4">
                    ...
                    >
                        Continue Shopping
                        <LuShoppingBag className="group-hover:translate-x-1 transition-transform" />
                    </Link>
                    ...
                    >
                        View My Orders
                        <LuPackage className="group-hover:rotate-12 transition-transform" />
                    </Link>
                </div>
