...
import {
    LuShield, LuDollarSign, LuPackage,
    LuLock, LuCompass, LuChartColumn,
    LuStar, LuChevronLeft, LuChevronRight, LuArrowRight,
} from 'react-icons/lu';
        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="w-full py-14 px-4 bg-gray-50">
                <div className="max-w-xl mx-auto text-center">
                    ...
                    >
                        Talk to The Expert <LuArrowRight size={16} />
                    </Link>
                </div>
            </section>
        </div>
