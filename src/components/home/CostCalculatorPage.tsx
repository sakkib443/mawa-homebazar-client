...
import { LuUser, LuHouse, LuMapPin, LuArrowRight, LuPackage, LuInfo } from 'react-icons/lu';
                    ...
                    {result && (
                        <div className="border-t border-gray-100 bg-[var(--color-primary-lightest)] px-8 py-6">
                            <h2 className="text-base font-bold text-gray-800 mb-4 flex items-center gap-2">
                                <LuPackage className="text-[var(--color-primary)]" />
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex flex-wrap items-center gap-2 text-sm text-gray-600 font-medium">
                                    <span className="flex items-center gap-1.5 bg-gray-50 border border-gray-100 rounded-full px-3 py-1.5">
                                        <LuUser size={14} className="text-[var(--color-primary)]" /> Seller
                                    </span>
                                    <LuArrowRight size={14} className="text-gray-300" />
                                    <span className="flex items-center gap-1.5 bg-gray-50 border border-gray-100 rounded-full px-3 py-1.5">
                                        <LuHouse size={14} className="text-[var(--color-primary)]" /> Source Warehouse
                                    </span>
                                    <LuArrowRight size={14} className="text-gray-300" />
                                    <span className="flex items-center gap-1.5 bg-gray-50 border border-gray-100 rounded-full px-3 py-1.5">
                                        <LuMapPin size={14} className="text-[var(--color-primary)]" /> Doorstep Delivery
                                    </span>
                                </div>
                            </div>
                            {/* Illustration */}
