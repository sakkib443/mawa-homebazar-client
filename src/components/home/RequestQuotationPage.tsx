...
import { LuArrowLeft, LuCircleCheck, LuCircleX, LuUpload } from 'react-icons/lu';
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="flex-1 bg-white rounded-2xl border border-gray-100 shadow-sm p-7">
                        ...
                        <div className="mb-8">
                            ...
                            >
                                <LuUpload size={28} className="text-green-500 mb-2" />
                                ...
                                {completenessFields.map(f => {
                                    ...
                                    return (
                                        <li key={f.key} className="flex items-center gap-2.5 text-sm">
                                            {filled
                                                ? <LuCircleCheck className="text-green-500 flex-shrink-0" size={17} />
                                                : <LuCircleX className="text-red-400 flex-shrink-0" size={17} />
                                            }
